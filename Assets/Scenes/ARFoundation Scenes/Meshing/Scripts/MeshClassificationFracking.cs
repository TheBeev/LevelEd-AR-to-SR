...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class MeshClassificationFracking : MonoBehaviour
    {
        ...
        public List<MeshFilter> listOfMeshFilters = new List<MeshFilter> ();

        /// <summary>
        /// A mapping from tracking ID to instantiated mesh filters.
        /// </summary>
        public readonly Dictionary<TrackableId, MeshFilter[]> m_MeshFrackingMap = new Dictionary<TrackableId, MeshFilter[]>();
        ...
        void BreakupMesh(MeshFilter meshFilter)
        {
            ...
            using (faceClassifications)
            {
                ...
                /*
                meshFilters[1] = (m_NoneMeshPrefab == null) ? null : Instantiate(m_NoneMeshPrefab, parent);
                ...
                meshFilters[3] = (m_SeatMeshPrefab == null) ? null : Instantiate(m_SeatMeshPrefab, parent);
                ...
                */
                ...
                print("breaking up the mesh and makign a list");
